...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root>>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-primary/50 bg-background shadow disabled:pointer-events-none disabled:opacity-50 transition-all md:scale-0 md:group-hover:scale-100" />
  </SliderPrimitive.Root>
))
