...
export const MiniPlayer = ({
    ...
    return (
        <ScrollArea className="w-full h-[100vh] max-w-full overflow-x-hidden">
            <div className="p-8 flex flex-col gap-2 transition-all bg-primary-foreground w-full justify-center max-w-screen overflow-hidden">
                ...
                <div className="flex flex-col gap-4 mt-0 rounded-2xl relative">
                    <Image
                        ...
                        alt={`${id.toLowerCase()}`}
                        sizes="100vw"
                        className="absolute inset-x-0 top-8 bg-cover bg-center blur-2xl w-full rounded-3xl h-96 touch-none select-none pointer-events-none opacity-0 dark:opacity-10"
                        fill
                    />
                    <TooltipProvider>
                        <Tooltip
                        ...
                        >
                            <TooltipTrigger asChild>
                                ...
                                >
                                    <div
                                        className={cn(
                                            "aspect-square max-w-xs sm:max-w-sm md:max-w-md mx-auto bg-black/80 backdrop-blur-md transition-opacity duration-700 absolute inset-0 rounded-xl",
                                            showLyrics
                                                ? "opacity-100"
                                                : "opacity-0",
                                            !isPlaying &&
                                    ...
                                    {(isLoading || isLoading === null) && (
                                        <div
                                            className={cn(
                                                "aspect-square size-fit mx-auto absolute inset-0 overflow-hidden bg-black/60 backdrop-blur-xl dark:bg-black/80",
                                                isLoading && "animate-pulse"
                                            )}
                                        >
                                            <div
                                                className={cn(
                                                    "aspect-square size-fit mx-auto relative",
                ...
                <div className="flex flex-col justify-center gap-8 w-full mt-10">
                    <div className="w-full flex flex-col gap-3">
                        <Slider
                            ...
                            max={100}
                            step={1}
                            className="w-full [&>:last-child>span]:bg-primary transition-all duration-500"
                            onValueChange={(value) =>
                                handleSliderChange(
                                    value,
                                    setSliderValue,
