        ...
        <>
            <div className="flex flex-col w-full h-full">
                <div className="flex items-center p-3 justify-between">
                    <div className="flex items-center gap-2 flex-1 select-none shadowed-song-name relative">
                        <Image
                            src={image}
                            alt={image}
                            width={60}
                    ...
                    <div className="flex justify-end gap-1" onClick={(e) => { e.stopPropagation(); e.preventDefault(); }}>
                        <Button className={`p-5 rounded-full ${songVal !== "" ? "" : "opacity-50 cursor-not-allowed"}`} size="icon" onClick={() => setIsPlaying(!isPlaying)}>
