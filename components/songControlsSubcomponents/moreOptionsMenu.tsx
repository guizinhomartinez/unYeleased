...
export const ShareMenu = (props: {
    ...
    return (
        <Drawer>
            ...
            <DrawerContent
                className="min-h-36 rounded-t-3xl bg-transparent"
                showGrabThing={false}
            >
                <div className="bg-primary-foreground/75 backdrop-blur-md w-[93%] translate-x-3.5 h-[95%] -translate-y-2 rounded-3xl border">
                    ...
                    <div className="flex items-center justify-center my-12 mx-2">
                        <div className="w-28 h-20 flex flex-col justify-center items-center gap-3">
                            <div
                                className="rounded-full p-5 bg-secondary active:bg-primary/30 active:scale-95 transition-all"
                                onClick={() => {
...
export const DownloadMenu = (props: {
    songVal: string;
    id: string;
    className?: string;
    onClick?: React.MouseEventHandler;
    ...
    return (
        <Button
            className={cn("rounded-full h-12 w-full", props.className)}
            size="icon"
            variant="secondary"
            onClick={() => {
                downloadSong();
