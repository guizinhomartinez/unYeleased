...
export default function Bully() {
    ...
    return (
        <Player image={"/song-files/covers/bully-big.jpg"} text={"Bully"} subtext={"Beauty and the Beast [BB-O1]"} songVal={"/song-files/songs//beauty-and-the-beast.m4a"} backgroundLore={bgLoreText} linkToGenius="https://genius.com/Kanye-west-beauty-and-the-beast-lyrics" lyrics="wip" />
    )
}