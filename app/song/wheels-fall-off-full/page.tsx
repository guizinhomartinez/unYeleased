...
export default function WheelsFallOffFull() {
    ...
    return (
        <Player image={"/song-files/covers/wheels-fall-off-big.jpg"} text={"Wheels Fall Off"} subtext={"Full Version [WFO-O1]"} songVal={"/song-files/songs//wheels-fall-off-full.m4a"} backgroundLore={bgLoreText} linkToGenius="https://genius.com/Ty-dolla-sign-wheels-fall-off-extended-lyrics" lyrics={lyrics()} />
    )
}
