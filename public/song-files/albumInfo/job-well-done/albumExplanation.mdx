...
the verse:
    ...
    <div className="border border-secondary rounded-lg" style={{fontFamily: 'var(--font-geist-mono)', marginTop: '0.5em', marginBottom: '0.5em', backgroundColor: 'hsl(var(--secondary) / 0.3'}}>
