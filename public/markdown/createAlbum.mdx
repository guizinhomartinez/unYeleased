...
<Separator orientation="horizontal" className="h-[2px] rounded-full bg-muted/80" />
        ...
        \
        **General configs:**
        <li className='mt-2'>`albumName` Sets the name of the album;</li>
        <li className='mt-2'>`albumCreator` Sets the name of the creator of the album;</li>
        <li className='mt-2'>`year` Sets the year that the album was supposed to release/was cancelled;</li>
        <li className='mt-2'>`credits` Is where you got the original song's files or the tracklist from;</li>
        \
        **Track-specific configs:**
        <li className='mt-2'>`title` Sets the name of the current track you're configuring</li>
        <li className='mt-2'>`artist` Sets the name of the current track you're configuring</li>
        <li className='mt-2'>`songLocation` Sets where the song is located. Please. Be sure to copy the way this is positioned here when adding this information.</li>
        \
...
<Separator orientation="horizontal" className="h-[2px] rounded-full bg-muted/80" />
        ...
        <li className='mt-2'>`year` Is the year the album was supposed to come out;</li>
        <li className='mt-2'>`row` Is which row it should be at (just put the last row's number + 1);</li>
        <li className='mt-2'>`image` Is the album's cover art;</li>
        <li className='mt-2'>`text` Is the album's name;</li>
        <li className='mt-2'>`subtext` Is just a description (put album for consistency purposes);</li>
        <li className='mt-2'>`duration` Is the album's duration;</li>
        <li className='mt-2'>`link` Is where the album is located (put `/album/album name here`).</li>
        \
