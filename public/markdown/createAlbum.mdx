...
<Separator orientation="horizontal" className="h-[2px] rounded-full bg-muted/80" />
        ...
        ```
        This is pretty confusing for someone who never messed with JSONs before, so let's break this down.
        \
        \
        **General configs:**
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`albumName`Sets the name of the album;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`albumCreator` Sets the name of the creator of the album;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`year` Sets the year that the album was supposed to release/was cancelled;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`credits` Is where you got the original song's files or the tracklist from;</li>
        \
        **Track-specific configs:**
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`title` Sets the name of the current track you're configuring</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`artist` Sets the name of the current track you're configuring</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`songLocation` Sets where the song is located. Please. Be sure to copy the way this is positioned here when adding this information.</li>
        \
...
<Separator orientation="horizontal" className="h-[2px] rounded-full bg-muted/80" />
        ...
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`year` Is the year the album was supposed to come out;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`row` Is which row it should be at (just put the last row's number + 1);</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`image` Is the album's cover art;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`text` Is the album's name;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`subtext` Is just a description (put album for consistency purposes);</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`duration` Is the album's duration;</li>
        <li className='mt-2' style={{marginLeft: '2.5em'}}>`link` Is where the album is located (put `/album/album name here`).</li>
        \
        This should cover all parts of adding an album, so there it is, go create one!
        \
        <>
            <div className='text-muted-foreground/80 mt-4 border border-secondary rounded-md p-4'>(If you have any idea on how to make this documentation better, please open an issue on the GitHub Page with your ideas, I don't know how to make docs.)</div>
        </>